import{a as g}from"./axios-CoTZsgdJ.js";import{j as y,p as E,q as k,u as T,r as H,o as I,m as B,f as w,a as C}from"./app-BrbyE2gb.js";import{_ as $}from"./plugin-vue_export-helper-DlAUqK2U.js";const M=y({__name:"HeroHitokoto",setup(x,{expose:a}){a();let r="https://api.apiopen.top/api/sentences";const m=t=>{const e=window;clearInterval(e.Timer);const o=document.getElementsByClassName("vp-blog-hero-description");if(o.length>0){const h=o[0];h.id="hotWord"}const l=document.getElementById("hotWord");if(!l)return;l.innerHTML=`
    <div class="word">
      <div class="left">
