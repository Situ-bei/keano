import{j as g,J as y,W as k,p as E,X as T,_ as H,r as I,o as B,m as w,f as C,a as W}from"./app-CcEkf0l0.js";const $=g({__name:"HeroHitokoto",setup(x,{expose:i}){i();let r="https://api.apiopen.top/api/sentences";const m=t=>{const e=window;clearInterval(e.Timer);const o=document.getElementsByClassName("vp-blog-hero-description");if(o.length>0){const f=o[0];f.id="hotWord"}const l=document.getElementById("hotWord");if(!l)return;l.innerHTML=`
    <div class="word">
      <div class="left">
