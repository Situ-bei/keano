import{a as g}from"./axios-CoTZsgdJ.js";import{j as y,J as E,W as k,p as T,r as H,o as I,m as B,f as w,a as C}from"./app-DahiUSEI.js";import{_ as W}from"./plugin-vue_export-helper-DlAUqK2U.js";const $=y({__name:"HeroHitokoto",setup(x,{expose:a}){a();let r="https://api.apiopen.top/api/sentences";const m=t=>{const e=window;clearInterval(e.Timer);const o=document.getElementsByClassName("vp-blog-hero-description");if(o.length>0){const h=o[0];h.id="hotWord"}const l=document.getElementById("hotWord");if(!l)return;l.innerHTML=`
    <div class="word">
      <div class="left">
