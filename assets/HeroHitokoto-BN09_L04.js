import{j as g,J as y,X as k,p as E,Y as T,_ as H,r as I,o as B,m as w,g as C,a as $}from"./app-CI2Mbx1E.js";const M=g({__name:"HeroHitokoto",setup(x,{expose:i}){i();let r="https://api.apiopen.top/api/sentences";const m=t=>{const e=window;clearInterval(e.Timer);const o=document.getElementsByClassName("vp-blog-hero-description");if(o.length>0){const f=o[0];f.id="hotWord"}const l=document.getElementById("hotWord");if(!l)return;l.innerHTML=`
    <div class="word">
      <div class="left">
