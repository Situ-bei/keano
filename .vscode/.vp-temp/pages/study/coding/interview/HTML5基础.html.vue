...
<li><code v-pre>HTML5</code> 在狭义上是指新一代的 <code v-pre>HTML</code> 标准，在广义上是指：整个前端。</li>
</ul>
<h2 id="_1-2-html5-优势" tabindex="-1"><a class="header-anchor" href="#_1-2-html5-优势"><span>1.2 HTML5 优势</span></a></h2>
<ol>
<li>针对 <code v-pre>JavaScript</code> ，新增了很多可操作的接口。</li>
<li>新增了一些语义化标签、全局属性。</li>
<li>新增了多媒体标签，可以很好的替代 <code v-pre>flash</code> 。</li>
<li>更加侧重语义化，对于 <code v-pre>SEO</code> 更友好。</li>
<li>可移植性好，可以大量应用在移动设备上。</li>
</ol>
<h2 id="_1-3-3-html5兼容性" tabindex="-1"><a class="header-anchor" href="#_1-3-3-html5兼容性"><span>1.3 3.HTML5兼容性</span></a></h2>
<p>支持： Chrome 、 Safari 、 Opera 、 Firefox 等主流浏览器。
IE 浏览器必须是 9 及以上版本才支持 <code v-pre>HTML5</code> ，且 IE9 仅支持部分 <code v-pre>HTML5</code> 新特性。</p>
<h1 id="_2-新增语义化标签" tabindex="-1"><a class="header-anchor" href="#_2-新增语义化标签"><span>2 新增语义化标签</span></a></h1>
<h2 id="_2-1-新增布局标签" tabindex="-1"><a class="header-anchor" href="#_2-1-新增布局标签"><span>2.1 新增布局标签</span></a></h2>
<p>![[Pasted image 20240628002803.png]]
关于 <code v-pre>article</code> 和 <code v-pre>section</code> ：</p>
<ol>
<li><code v-pre>artical</code> 里面可以有多个 <code v-pre>section</code> 。</li>
<li><code v-pre>section</code> 强调的是分段或分块，如果你想将一块内容分成几段的时候，可使用 <code v-pre>section</code> 元素。``</li>
<li><code v-pre>article</code> 比 <code v-pre>section</code> 更强调独立性，一块内容如果比较独立、比较完整，应该使用 <code v-pre>article</code> 元素。</li>
</ol>
...
<ul>
<li>语义：定义已知范围内的标量测量。也被称为 <code v-pre>gauge</code> （尺度），双标签，例如：电量、磁盘用量等。</li>
<li>常用属性如下：</li>
</ul>
<table>
<thead>
...
<ul>
<li>语义：显示某个任务完成的进度的指示器，一般用于表示进度条，双标签，例如：工作完成进度等。</li>
<li>常用属性如下：<div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" data-title="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">属性</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">   值</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">      描述</span></span>
...
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">value</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">  数值</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">  规定当前值。</span></span></code></pre>
...
<p>![[Pasted image 20240628003744.png]]</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">details</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
...
<p>![[Pasted image 20240628004024.png]]</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;/</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">ruby</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">></span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-2-文本标记" tabindex="-1"><a class="header-anchor" href="#_2-4-2-文本标记"><span>2.4.2 文本标记</span></a></h3>
<p>![[Pasted image 20240628004124.png]]</p>
<blockquote>
<p>注意： W3C 建议 <code v-pre>mark</code> 用于标记搜索结果中的关键字。</p>
</blockquote>
<h1 id="_3-新增表单功能" tabindex="-1"><a class="header-anchor" href="#_3-新增表单功能"><span>3 新增表单功能</span></a></h1>
<h2 id="_3-1-表单控件新增属性" tabindex="-1"><a class="header-anchor" href="#_3-1-表单控件新增属性"><span>3.1 表单控件新增属性</span></a></h2>
<p>![[Pasted image 20240628004200.png]]</p>
<h2 id="_3-2-input-新增属性值" tabindex="-1"><a class="header-anchor" href="#_3-2-input-新增属性值"><span>3.2 input 新增属性值</span></a></h2>
<p>![[Pasted image 20240628004228.png]]</p>
<h2 id="_3-3-form-标签新增属性" tabindex="-1"><a class="header-anchor" href="#_3-3-form-标签新增属性"><span>3.3 form 标签新增属性</span></a></h2>
<p>![[Pasted image 20240628004535.png]]</p>
<h1 id="_4-新增多媒体标签" tabindex="-1"><a class="header-anchor" href="#_4-新增多媒体标签"><span>4 新增多媒体标签</span></a></h1>
<h2 id="_4-1-视频标签" tabindex="-1"><a class="header-anchor" href="#_4-1-视频标签"><span>4.1 视频标签</span></a></h2>
<ul>
<li><code v-pre>&lt;video&gt;</code> 标签用来定义视频，它是双标签。
![[Pasted image 20240628004702.png]]</li>
</ul>
<h2 id="_4-2-音频标签" tabindex="-1"><a class="header-anchor" href="#_4-2-音频标签"><span>4.2 音频标签</span></a></h2>
<ul>
<li><code v-pre>&lt;audio&gt;</code> 标签用来定义音频，它是双标签。
![[Pasted image 20240628004751.png]]</li>
</ul>
<h1 id="_5-新增全局属性-了解" tabindex="-1"><a class="header-anchor" href="#_5-新增全局属性-了解"><span>5 新增全局属性（了解）</span></a></h1>
<p>![[Pasted image 20240628004813.png]]</p>
<h1 id="_6-html5兼容性处理" tabindex="-1"><a class="header-anchor" href="#_6-html5兼容性处理"><span>6 HTML5兼容性处理</span></a></h1>
<ul>
<li>
...
<li>
<p>使用 <code v-pre>html5shiv</code> 让低版本浏览器认识 <code v-pre>H5</code> 的语义化标签。</p>
...
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic">&#x3C;![endif]--></span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>扩展</p>
</li>
...
<span class="line"><span style="--shiki-light:white;--shiki-light-font-style:italic;--shiki-dark:#FFFFFF;--shiki-dark-font-style:italic">&#x3C;!--</span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic">[if !IE 8]>非IE8的IE可见&#x3C;![endif]--></span></span></code></pre>
