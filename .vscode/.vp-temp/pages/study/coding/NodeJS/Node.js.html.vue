...
<span class="line"><span>		这个方式使得它里边可以存储异步调用的结果</span></span></code></pre>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">			如果</span><span style="--shiki-light:#383A42;--shiki-dark:#E06C75">PromiseState</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">变为</span><span style="--shiki-light:#383A42;--shiki-dark:#E06C75">rejected</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">，则调用</span><span style="--shiki-light:#383A42;--shiki-dark:#E06C75">then</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">的第二个回调函数来返回数据</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><div class="language-js line-numbers-mode" data-highlighter="shiki" data-ext="js" data-title="js" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">catch</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">() 用法和</span><span style="--shiki-light:#383A42;--shiki-dark:#E06C75">then</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">类似，但是只需要一个回调函数作为参数</span></span>
...
<span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2">	-</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD"> finally</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">()通常用来编写一些无论成功与否都要执行代码</span></span></code></pre>
...
<span class="line"><span>            - finally的返回值，不会存储到新的Promise中</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><h2 id="_2-2-promise的静态方法" tabindex="-1"><a class="header-anchor" href="#_2-2-promise的静态方法"><span>2.2 Promise的静态方法</span></a></h2>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>静态方法</span></span>
...
<span class="line"><span>	Promise.any([...]) 返回执行最快的完成的Promise</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-3-async和await" tabindex="-1"><a class="header-anchor" href="#_2-3-async和await"><span>2.3 async和await</span></a></h2>
<p>nodejs文档： https://nodejs.dev/en/ 通过async可以快速的创建异步函数</p>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>通过async可以来创建一个异步函数</span></span>
<span class="line"><span>	异步函数的返回值会自动封装到一个Promise中返回</span></span>
<span class="line"><span>在async声明的异步函数中可以使用await关键字来调用异步函数</span></span></code></pre>
