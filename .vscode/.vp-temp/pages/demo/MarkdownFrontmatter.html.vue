<template><div><h2 id="markdownfrontmatter配置" tabindex="-1"><a class="header-anchor" href="#markdownfrontmatter配置"><span>MarkdownFrontmatter配置</span></a></h2>
<p>每次写东西前，都需要配置页面的 Frontmatter 于是我就写下来一些常用的 Frontmatter 方便随时查看，再有就是一些配置项目经常会忘了其作用是什么，下面就详细列取了一些常用的并注释了用法。</p>
...
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">article:</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> false</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-date" tabindex="-1"><a class="header-anchor" href="#_1-date"><span>1. date</span></a></h3>
<p>写作时间，格式: <code v-pre>YYYY-MM-DD</code> 或 <code v-pre>YYYY-MM-DD hh:mm:ss</code></p>
<p>似乎不支持详细到分钟秒。详细的配置可以查看<a href="https://theme-hope.vuejs.press/zh/guide/feature/page-info.html#%E5%86%99%E4%BD%9C%E6%97%A5%E6%9C%9F" target="_blank" rel="noopener noreferrer">官方文档</a></p>
<h3 id="_2-title" tabindex="-1"><a class="header-anchor" href="#_2-title"><span>2. title</span></a></h3>
<p>当前页面内容标题，默认为 Markdown 文件中的第一个 h1 标签内容。</p>
<p><strong>shortTitle</strong></p>
<p>当前页面的短标题，会在导航栏、侧边栏和路径导航中作为首选。</p>
<h3 id="_3-icon" tabindex="-1"><a class="header-anchor" href="#_3-icon"><span>3. icon</span></a></h3>
<p>当前页面图标的 FontClass 或文件路径 (建议填写)。</p>
<p>对于单页文章其实不是必须的，如果是文件夹，需要在 navbar 或者sidebar 中显示可以设置。</p>
<h3 id="_4-order" tabindex="-1"><a class="header-anchor" href="#_4-order"><span>4. order</span></a></h3>
<p>控制文章在侧边栏中的排序</p>
<p>通常情况下需要在 主题的配置文件中设置你的排序规则。
具体的排序配置项可以查看<a href="https://theme-hope.vuejs.press/zh/guide/layout/sidebar.html#%E8%BF%9B%E9%98%B6%E6%8E%A7%E5%88%B6" target="_blank" rel="noopener noreferrer">官方文档</a>。</p>
...
<p><code v-pre>readme</code>: README.md 或 readme.md 在前</p>
<p><code v-pre>order</code>: 正序在前并按其值升序排列，负序在后并按其值降序排列</p>
<p><code v-pre>date</code>: 按日期升序排序</p>
<p><code v-pre>date-desc</code>: 按日期降序排序</p>
<p><code v-pre>title</code>: 按标题字母顺序排序</p>
<p><code v-pre>filename</code>: 按文件名字母顺序排序</p>
</div>
<h3 id="_5-category" tabindex="-1"><a class="header-anchor" href="#_5-category"><span>5. category</span></a></h3>
<p>只需要在页面 frontmatter 中设置 category 数组，并设置一个或多个文章所属的分类，该文章会自动渲染在 <code v-pre>/category/&lt;分类名&gt;/</code> 分类页面的列表中。</p>
<p>你就可以在 <code v-pre>/category/html</code> 和 <code v-pre>/category/web</code> 页面下找到它。</p>
<h3 id="_6-tag" tabindex="-1"><a class="header-anchor" href="#_6-tag"><span>6. tag</span></a></h3>
<p>只需要在页面的 frontmatter 中设置 <code v-pre>tag</code>，并设置一个或多个文章所属的标签，该文章会自动渲染在 <code v-pre>/tag/&lt;标签名&gt;/</code> 标签页面的列表中。</p>
<p>你就可以在 <code v-pre>/tag/html</code> 和 <code v-pre>/tag/web </code>页面下找到它。</p>
<p>你可以从一下两个入口找到他们</p>
<figure><img src="@source/demo/images/image.png" alt="category/tag" tabindex="0" loading="lazy"><figcaption>category/tag</figcaption></figure>
<figure><img src="@source/demo/images/images1.png" alt="category/tag" tabindex="0" loading="lazy"><figcaption>category/tag</figcaption></figure>
<h3 id="_7-excerpt" tabindex="-1"><a class="header-anchor" href="#_7-excerpt"><span>7. excerpt</span></a></h3>
<p>对于文章在首页列表中的描述通常可以用 <code v-pre>&lt;!-- more --&gt;</code> 来注释，但是它们会出现在文章的正文中，如果要避免这个情况，可以使用 <code v-pre>excerpt</code> 来放置摘要。</p>
<p><code v-pre>excerpt</code>  可以直接写 <code v-pre>HTML</code> 语句。</p>
<p>例如这样：</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="_8-headerdepth" tabindex="-1"><a class="header-anchor" href="#_8-headerdepth"><span>8. headerDepth</span></a></h3>
<p>默认情况下，VuePress 只会从 Markdown 提取 h2 和 h3 标题</p>
<p>你需要在 VuePress 配置文件中配置<a href="https://vuejs.press/zh/reference/config.html#markdown-frontmatter" target="_blank" rel="noopener noreferrer">markdown.headers.level</a></p>
<div class="language-ts line-numbers-mode" data-highlighter="shiki" data-ext="ts" data-title=".vuepress/config.ts" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">import</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> { </span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">defineUserConfig</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> } </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">from</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> "vuepress"</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">;</span></span>
<span class="line"></span>
...
<span class="line highlighted"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  },</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">});</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在上方提取更深层级的标题后，你就能在 主题选项 或 页面 <strong>Frontmatter</strong> 中通过增加 <strong>headerDepth</strong> 的数值来展示更多标题了。</p>
<h3 id="_9-article-timeline-index" tabindex="-1"><a class="header-anchor" href="#_9-article-timeline-index"><span>9. article,timeline,index</span></a></h3>
<p>对于以上三个配置项目来讲，通常用来配置在一个问价夹目录的 README.md 中，不让其出现在 sidebar ， 文章列表，以及时间轴中，当然你可以配置任何你不想让它们出现在对应位置的文件。</p>
</div></template>
