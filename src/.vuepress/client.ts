...
export default defineClientConfig({
  ...
  setup() {
    onMounted(() => {
      console.log(
        `%c Keano的博客 V${packageJson.version}%c✨ https://github.com/Situ-bei/keano`,
        `background: #aa96da; padding:5px; font-size:12px; color: #ffffff; font-weight: bold;`,
    ...
    setupRunningTimeFooter(
      new Date("2024-10-01"),
      {
        "/": `<div class="footer-time">已运行 :day 天 :hour 小时 :minute 分钟 :second 秒</div>`,
