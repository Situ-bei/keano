...
帮我写一个todo 头部是一键全部完成和新增计划按钮，新增计划按钮弹出一个弹窗
...
2. 每个计划右侧有一个删除按钮
3. 每个计划左侧有一个完成按钮
4. 中间显示详情区域，详情左边区域显示计划标题 标题右边显示重要程度和标签，下面显示计划详情，
5. 详情左侧显示预计多长时间完成，下面显示开始时间和结束时间，再下面显示距离结束时间还有多长时间，待完成后显示完成时间